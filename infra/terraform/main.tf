terraform {
  ...
  backend "s3" {
    bucket         = "ragx-terraform-state"
    key            = "ragx/terraform.tfstate"
    region         = "eu-west-2"
    dynamodb_table = "ragx-terraform-lock"
    encrypt        = true
  }
}
...
variable "project_name" { default = "ragx" }
...
resource "aws_cloudwatch_metric_alarm" "api_errors" {
  ...
  metric_name         = "ragx_requests_total"
  namespace           = "RAGX"
  period              = "120"
  statistic           = "Sum"
  threshold           = "10"
...
resource "aws_sns_topic_subscription" "email" {
  ...
  protocol  = "email"
  endpoint  = "amritanshu0507@gmail.com"
}
